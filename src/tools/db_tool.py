...
from src.repository.velocity_dao import save_commit_record, commit_exists, figma_event_exists, save_figma_record, get_project_team_status
...
def team_status_tool() -> str:
    """Queries the PostgreSQL database and returns the deterministic activity status of all team contributions."""
    return get_project_team_status()